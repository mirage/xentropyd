...
(* OASIS_START *)
(* DO NOT EDIT (digest: 80d0551bec472420294f8258b816b4bb) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["S"; "Conback"; "Conproto"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\160\175\149\221\207\248v\229\137\202\146\235\178]\173,";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
